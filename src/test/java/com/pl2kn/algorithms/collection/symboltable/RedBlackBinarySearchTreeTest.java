...
public class RedBlackBinarySearchTreeTest extends SymbolTableTest {
  ...
  public void Rank_Left_Test() throws IllegalAccessException {
    RedBlackBinarySearchTree<String, Integer> symbolTable = new RedBlackBinarySearchTree<>();
  ...
  public void Delete_Min_Test() throws IllegalAccessException {
    RedBlackBinarySearchTree<Integer, Integer> symbolTable = new RedBlackBinarySearchTree<>();
